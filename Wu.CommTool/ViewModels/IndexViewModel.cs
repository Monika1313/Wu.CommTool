...
{
    public class IndexViewModel : NavigationViewModel, IDialogHostAware
    {
        #region **************************************** 字段 ****************************************
        ...
        public IndexViewModel(IContainerProvider provider, IDialogHostService dialogHost) : base(provider)
        {
